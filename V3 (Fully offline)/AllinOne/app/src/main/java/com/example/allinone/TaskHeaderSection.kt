...
class TaskHeaderSection(
    private val rootView: View,
    private val onBack: () -> Unit,
    private val onSearchChanged: (String) -> Unit,
    private val onSettingsClicked: (View) -> Unit
) {
    private val etSearch: EditText = rootView.findViewById(R.id.et_task_search)
    private val btnSearch: ImageButton = rootView.findViewById(R.id.btn_task_search)
    private val btnSettings: ImageButton = rootView.findViewById(R.id.btn_task_settings)
